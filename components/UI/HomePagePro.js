  ...
  return (
    ...
    <div
      ...
      >
           ...
           <div >
              <h1  style={{fontSize:"60px", color:"blue", fontFamily:"inherit", fontWeight:"500"}}  >RESEARCH</h1>
              <h1  style={{fontSize:"50px", color:"red", fontFamily:"inherit", marginLeft:"20px", fontWeight:"500"}}  >@MBM</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium illum ducimus iusto, quod obcaecati blanditiis. Laudantium illum ducimus iusto, quod obcaecati blanditiis. Veritatis nulla corrupti quisquam dolor assumenda maiores omnis, voluptatum officia</p>
